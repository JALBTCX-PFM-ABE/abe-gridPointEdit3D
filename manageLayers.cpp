  ...
  QDialog (parent, (Qt::WindowFlags) Qt::WA_DeleteOnClose)
{
  ...
  setWindowTitle ("gridPointEdit3D Layer Preferences");
  ...
  for (int32_t i = 0 ; i < misc->chrtr2_share->chrtr2_count ; i++)
    {
      ...
      display[i]->setChecked (misc->chrtr2_share->display_chrtr2[i]);
